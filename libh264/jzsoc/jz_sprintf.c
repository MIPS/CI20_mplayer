...
#define STR_FILE JZFS_FILE 



typedef struct sFile STR_FILE;
...
extern int __sfvwrite(STR_FILE *, struct __suio *);
extern int __swsetup(STR_FILE *);
...
int __sfvwrite (STR_FILE *fp, struct __suio *uio)
{
  register size_t len;
 ...
 */
static int __sprint(STR_FILE *fp, struct __suio *uio)
{
        int err;
...
int 
_vfprintf_r(STR_FILE * fp, __const char *__restrict fmt0, _G_va_list ap)
{
...
int vfprintf (STR_FILE *__restrict fp, __const char *__restrict fmt0,
                     _G_va_list ap)
{
  CHECK_INIT (fp);
...
int mm_printf (char *__restrict str, __const char *__restrict fmt, ...)
{
  int ret;
  _G_va_list ap;
  STR_FILE f;
