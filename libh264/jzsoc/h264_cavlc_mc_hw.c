...
void vlc_motion_task(int bar,
		 int *tdd, int *tkn, 
		 int list0, int list1,
		 int blkh, int blkw,
		 int boy, int box,short *mvp[2], struct MB_INTER_P_VLC *ptr)
{
...
void vlc_motion_execute(unsigned int *mc_dha,unsigned int next_motion_dha, unsigned int sde_ctrl_dout,int slice_type, int mb_x, int mb_y)
{
  ...
  *((volatile unsigned int*)next_motion_dha) = 0 ;
  ...
  short *mvp[2];
  mb_inter_p_vlc_p ptr = (struct MB_INTER_P_VLC *)sde_ctrl_dout;
