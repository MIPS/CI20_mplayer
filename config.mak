...
CONFIGURATION = --host-cc=gcc --cc=mipsel-linux-gcc -mips32 --target=mips-linux --enable-cross-compile --ar=mipsel-linux-ar --ranlib=mipsel-linux-ranlib --disable-x11 --disable-xinerama --disable-vm --disable-termcap --disable-freetype --enable-fbdev --enable-alsa --enable-ossaudio --disable-esd --disable-ivtv --enable-hardcoded-tables --disable-mencoder --disable-mp3lib --enable-mad --disable-speex --disable-sdl --disable-iconv --disable-faac --disable-faac-lavc --enable-pvr --enable-tv-v4l1 --enable-tv-v4l2 --extra-ldflags=-L./libmad --extra-cflags=-I./libmad/libmad-0.15.1b/ -imacros ./libjzcommon/com_config.h
...
EXTRALIBS          = -L./libmad -ffast-math  -lpng -lz -lmng -lz -ljpeg -lasound -ldl -lpthread -lfribidi -lz -lbz2 -lmad -lpthread -ldl -rdynamic  -lm 
EXTRALIBS_MPLAYER  =  -lXss
EXTRALIBS_MENCODER = 
